  ...
  >
    ...
    <div class="p-3 flex flex-col flex-1 justify-between gap-2 relative">
      <div class="flex flex-col flex-1">
        ...
        <!-- ✅ Eligible Offer Text -->
        <p
          class="text-green-600 text-[10px] sm:text-xs font-semibold mt-1 animate-offer-entry"
        >
          Eligible for 2 for ₹1499
        </p>
      </div>
    </div>
  </div>
...
/* ✅ Subtle entry animation for the offer text */
@keyframes offer-entry {
  0% { opacity: 0; transform: translateY(3px) scale(0.95); }
  100% { opacity: 1; transform: translateY(0) scale(1); }
}
.animate-offer-entry {
  animation: offer-entry 0.5s ease-out forwards;
}
</style>
