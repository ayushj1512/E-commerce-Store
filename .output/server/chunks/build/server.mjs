import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, computed, useSSRContext } from 'vue';
import { h as createError$1, k as hasProtocol, m as isScriptProtocol, l as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, $ as $fetch, p as createHooks, q as executeAsync, v as toRouteMatcher, x as createRouter$1, y as defu } from '../_/nitro.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'vue/server-renderer';
import { Menu, SearchIcon, ShoppingCart, User, Heart, X, Camera } from 'lucide-vue-next';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bf6atn1Y.mjs')
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./index-f1sTjZKy.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./index-DwcJBaIo.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./index-C1voo_R6.mjs')
  },
  {
    name: "parent-slug",
    path: "/:parent()/slug",
    component: () => import('./slug-Cw9mNQ72.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./index-CR-p-oBe.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": ["auth"] },
    component: () => import('./index-CkZ03I_3.mjs')
  },
  {
    name: "parent",
    path: "/:parent()",
    component: () => import('./index-BUlBStJC.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./index-PtgIAj03.mjs')
  },
  {
    name: "login-register",
    path: "/login/register",
    component: () => import('./register-DZ_DUkXN.mjs')
  },
  {
    name: "profile-orders",
    path: "/profile/orders",
    component: () => import('./orders-D7wmOCL1.mjs')
  },
  {
    name: "trending",
    path: "/trending",
    component: () => import('./index-D-UJSkQp.mjs')
  },
  {
    name: "wishlist",
    path: "/wishlist",
    component: () => import('./index-e-XQrzQ0.mjs')
  },
  {
    name: "profile-refunds",
    path: "/profile/refunds",
    meta: { "middleware": ["auth"] },
    component: () => import('./refunds-BG6MNfNm.mjs')
  },
  {
    name: "profile-support",
    path: "/profile/support",
    component: () => import('./support-CpMGkMo3.mjs')
  },
  {
    name: "influencer",
    path: "/influencer",
    component: () => import('./index-C8yMBtVx.mjs')
  },
  {
    name: "profile-vouchers",
    path: "/profile/vouchers",
    component: () => import('./vouchers-B9TElaP7.mjs')
  },
  {
    name: "add-product",
    path: "/add-product",
    component: () => import('./index-Bk4tu18w.mjs')
  },
  {
    name: "collection12",
    path: "/collection12",
    component: () => import('./index-BwSyMmWJ.mjs')
  },
  {
    name: "influencer-register",
    path: "/influencer/register",
    component: () => import('./register-BLtIQ7rl.mjs')
  },
  {
    name: "order-success",
    path: "/order-success",
    component: () => import('./index-BUROJ6XB.mjs')
  },
  {
    name: "profile-add-address",
    path: "/profile/add-address",
    component: () => import('./add-address-Cgdk3xA5.mjs')
  },
  {
    name: "profile-deactivation",
    path: "/profile/deactivation",
    component: () => import('./deactivation-DScxYzhO.mjs')
  },
  {
    name: "influencer-onboarding",
    path: "/influencer/onboarding",
    component: () => import('./onboarding-xI235yub.mjs')
  },
  {
    name: "parent-child",
    path: "/:parent()/:child()",
    component: () => import('./index-Z5mqs-oU.mjs')
  },
  {
    name: "parent-child-product-id",
    path: "/:parent()/:child()/:product()/:id()",
    component: () => import('./index-ByZBXXiW.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CuWYoOBQ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D67kyYdK.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, entry$1 as default, createError as e, useCartStore as f, useRoute as g, defineNuxtRouteMiddleware as h, navigateTo as n, resolveRouteObject as r, useRouter as u };
